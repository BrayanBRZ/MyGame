...
void Player::Moviment()
{
    ...
    if (Event::GetInstance()->GetKeyDown(SDL_SCANCODE_W))
    {
        ...
        m_RigidBody.ApplyForceY(m_RigidBody.m_Force.y + (10000.0f * SCALE_HEIGHT * UPWARD));
    }
    ...
    if (Event::GetInstance()->GetKeyDown(SDL_SCANCODE_S))
    {
        ...
        m_RigidBody.ApplyForceY(m_RigidBody.m_Force.y + (10000.0f * SCALE_HEIGHT * DOWNWARD));
    }
    ...
    if (Event::GetInstance()->GetKeyDown(SDL_SCANCODE_A))
    {
        ...
        m_RigidBody.ApplyForceX(m_RigidBody.m_Force.x + (10000.0f * SCALE_WIDTH * LEFTWARD));
    }
    ...
    if (Event::GetInstance()->GetKeyDown(SDL_SCANCODE_D))
    {
        ...
        m_RigidBody.ApplyForceX(m_RigidBody.m_Force.x + (10000.0f * SCALE_WIDTH * RIGHTWARD));
    }
}